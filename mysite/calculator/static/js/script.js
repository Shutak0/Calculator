var x = document.querySelector("#Loansize");
var y = document.querySelector("#Percent");
var z = document.querySelector("#Months");
var k = document.querySelector("#funct");
...
k.addEventListener('click',function(){
    d = ((Number(x.value) + (Number(x.value)/100*Number(y.value))*Number(z.value)));
    document.querySelector("#solution").innerHTML = d;
})
